...
--dsl\_to\_python.py - Converts .tree files to Python (py_trees)
...
python ./src/dsl\_to\_behaverify.py ./metamodel/behaverify.tx /path/to/tree.tree --output_file /path/to/smv.smv
...
python ./src/dsl\_to\_pytree.py ./metamodel/behaverify.tx /path/to/tree.tree /path/to/folder/ fileName 
...
python /path/to/folder/fileName\_runner.py
