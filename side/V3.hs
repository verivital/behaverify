...
nextStates state = nextStates
  where
    ...
    varA_stage1_func :: Integer -> Integer -> Set.Set Integer
    varA_stage1_func varA_val varB_val
      | varA_val < varB_val = Set.singleton varA_val
      | otherwise = Set.fromList [((+) varA_val 1), ((-) varB_val 1)]
    varA_stage1 = Set.foldr (Set.union . 
