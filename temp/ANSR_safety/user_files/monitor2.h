...
#ifndef NURV_CODEGEN_MONITOR_MONITOR2
#define NURV_CODEGEN_MONITOR_MONITOR2
...
#define monitor2_segment 30 /* number of 'bits' stored in each long state */
#define monitor2_width   1 /* minimal value of 'width' in the function call */
...
RV_value monitor2_scalar
  (monitor2_input_t *input,
   monitor2_mask_t *masks, /* NULL (no masks) means fully observable */
   RV_reset reset,
   int *current_loc);

#endif /* NURV_CODEGEN_MONITOR_MONITOR2 */
