...
#ifndef NURV_CODEGEN_MONITOR_MONITOR3
#define NURV_CODEGEN_MONITOR_MONITOR3
...
#define monitor3_segment 30 /* number of 'bits' stored in each long state */
#define monitor3_width   1 /* minimal value of 'width' in the function call */
...
RV_value monitor3_scalar
  (monitor3_input_t *input,
   monitor3_mask_t *masks, /* NULL (no masks) means fully observable */
   RV_reset reset,
   int *current_loc);

#endif /* NURV_CODEGEN_MONITOR_MONITOR3 */
