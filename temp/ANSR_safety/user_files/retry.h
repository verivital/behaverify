...
#ifndef NURV_CODEGEN_MONITOR_RETRY
#define NURV_CODEGEN_MONITOR_RETRY
...
#define retry_segment 30 /* number of 'bits' stored in each long state */
#define retry_width   1 /* minimal value of 'width' in the function call */
...
RV_value retry_scalar
  (retry_input_t *input,
   retry_mask_t *masks, /* NULL (no masks) means fully observable */
   RV_reset reset,
   int *current_loc);

#endif /* NURV_CODEGEN_MONITOR_RETRY */
