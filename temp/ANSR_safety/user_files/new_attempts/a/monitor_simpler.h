...
#ifndef NURV_CODEGEN_MONITOR_MONITOR_SIMPLER
#define NURV_CODEGEN_MONITOR_MONITOR_SIMPLER
...
#define monitor_simpler_segment 30 /* number of 'bits' stored in each long state */
#define monitor_simpler_width   1 /* minimal value of 'width' in the function call */
...
/* INFO: input ordering:
   ...
   system_current_action.2 (system.current_action.2) : 6
   system_current_action.1 (system.current_action.1) : 7
   system_current_action.0 (system.current_action.0) : 8
*/
...
} monitor_simpler_mask_t;

/* 3. scalar API */
RV_value monitor_simpler_scalar
  (monitor_simpler_input_t *input,
   monitor_simpler_mask_t *masks, /* NULL (no masks) means fully observable */
   RV_reset reset,
   int *current_loc);

#endif /* NURV_CODEGEN_MONITOR_MONITOR_SIMPLER */
