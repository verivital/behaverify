...
/* INFO: input ordering:
   system_drone_x.0 (system.drone_x.0) : 0
   system_drone_y.0 (system.drone_y.0) : 1
   system_current_action.2 (system.current_action.2) : 2
   system_current_action.1 (system.current_action.1) : 3
   system_current_action.0 (system.current_action.0) : 4
*/
