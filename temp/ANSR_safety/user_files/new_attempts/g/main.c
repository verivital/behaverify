	...
	for (int ey = 0; ey <= 2; ey++){
	  for (int dir_loc = 0; dir_loc < 5; dir_loc++){
	    for (int speed = 1; speed <= 2; speed++){
	      ...
	      start_state.system_going_left = dirs[dir_loc] == 0;
	      start_state.system_going_right = dirs[dir_loc] == 1;
	      start_state.system_going_down = dirs[dir_loc] == 2;
	      start_state.system_going_up = dirs[dir_loc] == 3;
	      ...
	      end_state.system_going_left = dirs[dir_loc] == 0;
	      end_state.system_going_right = dirs[dir_loc] == 1;
	      end_state.system_going_down = dirs[dir_loc] == 2;
	      end_state.system_going_up = dirs[dir_loc] == 3;
