...
#ifndef NURV_CODEGEN_MONITOR_MONITOR1
#define NURV_CODEGEN_MONITOR_MONITOR1
...
#define monitor1_segment 30 /* number of 'bits' stored in each long state */
#define monitor1_width   1 /* minimal value of 'width' in the function call */
...
RV_value monitor1_scalar
  (monitor1_input_t *input,
   monitor1_mask_t *masks, /* NULL (no masks) means fully observable */
   RV_reset reset,
   int *current_loc);

#endif /* NURV_CODEGEN_MONITOR_MONITOR1 */
