...
\node[Blackboard, anchor=south east] (initialValues) at ([xshift=-5pt, yshift=5pt]Drone.north west){\begin{tabular}{l}\texttt{-INITIAL VALUES-}\\{}\begin{math}\end{math}\begin{math}\BlVarTikz{act} \in \end{math}\begin{math}\{\texttt{\textquotesingle{}XX\textquotesingle{}}\}\end{math}\\\begin{math}\end{math}\begin{math}\BlVarTikz{new} \in \end{math}\begin{math}\{\False{}\}\end{math}\\\begin{math}\end{math}\begin{math}\EnvVarTikz{x\_d} \in \end{math}\begin{math}\{0\}\end{math}\\\begin{math}\end{math}\begin{math}\EnvVarTikz{y\_d} \in \end{math}\begin{math}\{0\}\end{math}\\\begin{math}\end{math}\begin{math}\EnvVarTikz{x\_g} \in \end{math}\begin{math}\{\EnvVarTikz{x\_d}\}\end{math}\\\begin{math}\end{math}\begin{math}\EnvVarTikz{y\_g} \in \end{math}\begin{math}\{\EnvVarTikz{y\_d}\}\end{math}\\\texttt{NN(}\begin{math}\EnvVarTikz{x\_d}, \EnvVarTikz{y\_d}, \EnvVarTikz{x\_g}, \EnvVarTikz{y\_g}\end{math}\texttt{)}\\{}\begin{math}\end{math}\begin{math}\texttt{temp} \coloneqq{}\end{math}[\begin{math}9\end{math}, \begin{math}2\end{math}, \begin{math}9\end{math}, \begin{math}0\end{math}, \begin{math}8\end{math}, \begin{math}9\end{math}, \begin{math}8\end{math}, \begin{math}0\end{math}, \\\begin{math}\quad{}\end{math}\begin{math}7\end{math}, \begin{math}6\end{math}, \begin{math}6\end{math}, \begin{math}9\end{math}, \begin{math}6\end{math}, \begin{math}8\end{math}, \begin{math}6\end{math}, \begin{math}7\end{math}, \begin{math}6\end{math}, \begin{math}4\end{math}, \\\begin{math}\quad{}\end{math}\begin{math}6\end{math}, \begin{math}2\end{math}, \begin{math}6\end{math}, \begin{math}1\end{math}, \begin{math}5\end{math}, \begin{math}5\end{math}, \begin{math}4\end{math}, \begin{math}9\end{math}, \begin{math}4\end{math}, \begin{math}5\end{math}, \\\begin{math}\quad{}\end{math}\begin{math}3\end{math}, \begin{math}9\end{math}, \begin{math}3\end{math}, \begin{math}8\end{math}, \begin{math}3\end{math}, \begin{math}3\end{math}, \begin{math}3\end{math}, \begin{math}2\end{math}, \begin{math}2\end{math}, \begin{math}5\end{math}, \\\begin{math}\quad{}\end{math}\begin{math}0\end{math}, \begin{math}8\end{math}, \begin{math}0\end{math}, \begin{math}4\end{math}, \begin{math}0\end{math}, \begin{math}2\end{math}]\\\begin{math}\end{math}\texttt{for index in len(temp):}\\\begin{math}\quad{}\end{math}\begin{math}\EnvVarTikz{obstacles}[\texttt{index}] \coloneqq{} \texttt{temp[index]}\end{math}\\\begin{math}\end{math}\begin{math}\texttt{temp} \coloneqq{}\end{math}[\begin{math}0\end{math}, \begin{math}0\end{math}, \begin{math}0\end{math}, \begin{math}0\end{math}, \begin{math}0\end{math}, \begin{math}0\end{math}, \begin{math}0\end{math}, \begin{math}0\end{math}, \\\begin{math}\quad{}\end{math}\begin{math}1\end{math}, \begin{math}0\end{math}, \begin{math}1\end{math}, \begin{math}0\end{math}, \begin{math}0\end{math}, \begin{math}0\end{math}, \begin{math}0\end{math}, \begin{math}0\end{math}, \begin{math}0\end{math}, \begin{math}0\end{math}, \\\begin{math}\quad{}\end{math}\begin{math}0\end{math}, \begin{math}0\end{math}, \begin{math}0\end{math}, \begin{math}0\end{math}]\\\begin{math}\end{math}\texttt{for index in len(temp):}\\\begin{math}\quad{}\end{math}\begin{math}\EnvVarTikz{obstacle\_sizes}[\texttt{index}] \coloneqq{} \texttt{temp[index]}\end{math}\\\end{tabular}};
