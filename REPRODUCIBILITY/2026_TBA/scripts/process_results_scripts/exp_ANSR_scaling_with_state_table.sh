...
python3 ./build_table.py --folder_name ANSR_scaling_with_state --file_name ANSR_scaling_with_state_flat ANSR_scaling_with_state_square --minV $min_val --maxV $max_val --step $step_size --xLabel "n" --encodings "full_opt"
