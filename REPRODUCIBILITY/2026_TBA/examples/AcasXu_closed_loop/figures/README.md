...
|---|---|---|
| `--specs` | `contracts/acas_contract_specs.json` | Contract spec JSON |
...
| Flag | Default | Description |
|---|---|---|
| `--results` | `contracts/acas_verified_nn1.json` | CROWN results JSON for NN_1 |
| `--specs` | `contracts/acas_contract_specs.json` | Contract spec JSON (for bounding boxes) |
