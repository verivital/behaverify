...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--config",    default=str(_DEFAULT_CONFIG),    help=f"verify_contracts YAML (default: {_DEFAULT_CONFIG})")
...
def main() -> None:
    ...
    contracts_metrics = (
        skip_contracts(ctx) if ctx["skip_contracts"]
        else run_contracts(ctx)
    )
