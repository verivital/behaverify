...
./exp_bigger_fish_create.sh $python_behaverify 50 500 50
cd "${this_script_location}/scripts/encoding_timing_scripts"
./exp_bigger_fish_run.sh 50 500 50
cd "${this_script_location}/scripts/process_results_scripts"
./exp_bigger_fish_table.sh $python_results 50 500 50

cd "${this_script_location}/scripts/build_scripts"
./exp_simple_robot_create.sh $python_behaverify 2 18 4
cd "${this_script_location}/scripts/encoding_timing_scripts"
./exp_simple_robot_run.sh 2 18 4
cd "${this_script_location}/scripts/process_results_scripts"
./exp_simple_robot_table.sh $python_results 2 18 4
