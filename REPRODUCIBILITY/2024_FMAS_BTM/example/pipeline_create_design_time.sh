...
for category in "${categories[@]}"; do
	...
	python3 ./extra_files/assemble_tree_existing_obs.py "${category}/${tail_end}/design_time/obstaclesFilled_${tail_end}.txt" "./extra_files/template_monitor_design_time.tree"
    done
done
