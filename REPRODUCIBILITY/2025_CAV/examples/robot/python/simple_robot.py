...
def create_tree(environment):
    get_position = get_position_file.get_position('get_position', environment)
    target_reached = target_reached_file.target_reached('target_reached')
    clear_mission = clear_mission_file.clear_mission('clear_mission', environment)
    ...
    get_mission = get_mission_file.get_mission('get_mission', environment)
    ...
    go_right = go_right_file.go_right('go_right', environment)
    ...
    go_left = go_left_file.go_left('go_left', environment)
    ...
    go_up = go_up_file.go_up('go_up', environment)
    ...
    go_down = go_down_file.go_down('go_down', environment)
