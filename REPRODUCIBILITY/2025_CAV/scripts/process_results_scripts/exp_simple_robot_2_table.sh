...
encoding_groups=("opt")
# encoding_groups=("simple_robot_2")
for encoding_group in "${encoding_groups[@]}"; do
    ...
    $python_command ./build_table.py --folder_name simple_robot_2 --file_name simple_robot_2 --minV $min_val --maxV $max_val --step $step_size --xLabel "Grid Size" --encodings $encoding_group
done
