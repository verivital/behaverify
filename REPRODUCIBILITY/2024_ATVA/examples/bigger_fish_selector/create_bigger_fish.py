...
def create_tree_move4bt(x):
    return (
        ...
        + 'tree {' + os.linesep
        + 'composite {' + os.linesep
        + indent(1) + 'move4bt_selector' + os.linesep
        + indent(1) + 'selector' + os.linesep
        + indent(1) + 'children {' + os.linesep
        + indent(2) + 'biggest_fish_sequence' + os.linesep
        + indent(2) + 'sequence' + os.linesep
        + indent(2) + 'children {' + os.linesep
        + create_subtree_selector(3, x)
        + indent(3) + 'bigger_fish {}' + os.linesep
        + indent(2) + '} end_children' + os.linesep
        + indent(2) + 'move4bt_check : biggest_fish_is_X {' + str(x + 1) + '}' + os.linesep
        + indent(1) + '} end_children' + os.linesep
        + '} end_composite' + os.linesep
        + '} end_tree' + os.linesep
    )
...
def create_specifications_move4bt(_):
    return (
        'tick_prerequisite { True }' + os.linesep
        + 'specifications {' + os.linesep
        + indent(1) + 'LTLSPEC { (finally, (globally, (success, move4bt_check))) } end_LTLSPEC' + os.linesep
        + '} end_specifications'
    )
