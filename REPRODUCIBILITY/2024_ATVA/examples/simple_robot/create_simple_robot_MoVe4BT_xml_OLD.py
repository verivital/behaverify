...
def create_fish_selector(grid_size):
    return (
        ...
        + ''.join([
            (
                indent(7) + '<Sequence name="RX' + str(x_val) + '">' + os.linesep
                + indent(8) + '<Condition ID="ICRX' + str(x_val) + '" failure_guard="0==0" name="NCRX' + str(x_val) + '" success_guard="0==0"/>' + os.linesep
                + indent(8) + '<Action ID="IARX' + str(x_val) + '" failure_guard="0==1" name="NARX' + str(x_val) + '" running_guard="0==1" success_guard="0==0" success_program="gx=' + str(x_val) + '"/>' + os.linesep
                + indent(7) + '</Sequence>' + os.linesep
            )
        ...
        + ''.join([
            (
                indent(7) + '<Sequence name="RY' + str(y_val) + '">' + os.linesep
                + indent(8) + '<Condition ID="ICRY' + str(y_val) + '" failure_guard="0==0" name="NCRY' + str(y_val) + '" success_guard="0==0"/>' + os.linesep
                + indent(8) + '<Action ID="IARY' + str(y_val) + '" failure_guard="0==1" name="NARY' + str(y_val) + '" running_guard="0==1" success_guard="0==0" success_program="gy=' + str(y_val) + '"/>' + os.linesep
                + indent(7) + '</Sequence>' + os.linesep
            )
        ...
        + ''.join([
            (
                indent(2) + '<Condition ID="ICRX' + str(val) + '">' + os.linesep
                ...
                + indent(2) + '<Condition ID="ICRY' + str(val) + '">' + os.linesep
                + indent(3) + '<inout_port name="success_guard"/>' + os.linesep
                + indent(3) + '<inout_port name="failure_guard"/>' + os.linesep
                + indent(2) + '</Condition>' + os.linesep
                + indent(2) + '<Action ID="IARX' + str(val) + '">' + os.linesep
                + indent(3) + '<inout_port name="success_guard"/>' + os.linesep
                ...
                + indent(2) + '<Action ID="IARY' + str(val) + '">' + os.linesep
                + indent(3) + '<inout_port name="success_guard"/>' + os.linesep
                + indent(3) + '<inout_port name="success_program"/>' + os.linesep
                + indent(3) + '<inout_port name="failure_guard"/>' + os.linesep
                + indent(3) + '<inout_port name="running_guard"/>' + os.linesep
        ...
        + indent(2) + '<Condition ID="IXS">' + os.linesep
        + indent(3) + '<inout_port name="success_guard"/>' + os.linesep
        + indent(3) + '<inout_port name="failure_guard"/>' + os.linesep
        + indent(2) + '</Condition>' + os.linesep
        + indent(2) + '<Condition ID="IXB">' + os.linesep
        + indent(3) + '<inout_port name="success_guard"/>' + os.linesep
        + indent(3) + '<inout_port name="failure_guard"/>' + os.linesep
        + indent(2) + '</Condition>' + os.linesep
        + indent(2) + '<Condition ID="IYS">' + os.linesep
        + indent(3) + '<inout_port name="success_guard"/>' + os.linesep
        + indent(3) + '<inout_port name="failure_guard"/>' + os.linesep
        + indent(2) + '</Condition>' + os.linesep
        + indent(2) + '<Condition ID="IYB">' + os.linesep
        + indent(3) + '<inout_port name="success_guard"/>' + os.linesep
        + indent(3) + '<inout_port name="failure_guard"/>' + os.linesep
        + indent(2) + '</Condition>' + os.linesep
        + indent(2) + '<Action ID="IGL">' + os.linesep
        + indent(3) + '<inout_port name="success_guard"/>' + os.linesep
        + indent(3) + '<inout_port name="success_program"/>' + os.linesep
        + indent(3) + '<inout_port name="failure_guard"/>' + os.linesep
        + indent(3) + '<inout_port name="running_guard"/>' + os.linesep
        + indent(2) + '</Action>' + os.linesep
        + indent(2) + '<Action ID="IGR">' + os.linesep
        + indent(3) + '<inout_port name="success_guard"/>' + os.linesep
        + indent(3) + '<inout_port name="success_program"/>' + os.linesep
        + indent(3) + '<inout_port name="failure_guard"/>' + os.linesep
        + indent(3) + '<inout_port name="running_guard"/>' + os.linesep
        + indent(2) + '</Action>' + os.linesep
        + indent(2) + '<Action ID="IGU">' + os.linesep
        + indent(3) + '<inout_port name="success_guard"/>' + os.linesep
        + indent(3) + '<inout_port name="success_program"/>' + os.linesep
        + indent(3) + '<inout_port name="failure_guard"/>' + os.linesep
        + indent(3) + '<inout_port name="running_guard"/>' + os.linesep
        + indent(2) + '</Action>' + os.linesep
        + indent(2) + '<Action ID="IGD">' + os.linesep
        + indent(3) + '<inout_port name="success_guard"/>' + os.linesep
        + indent(3) + '<inout_port name="success_program"/>' + os.linesep
        + indent(3) + '<inout_port name="failure_guard"/>' + os.linesep
        + indent(3) + '<inout_port name="running_guard"/>' + os.linesep
