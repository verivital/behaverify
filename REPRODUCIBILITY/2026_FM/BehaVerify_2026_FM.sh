...
./exp_tool_comparisons_2026_FM_create.sh $python_behaverify $binary_tree_min $binary_tree_max $binary_tree_step
cd "${this_script_location}/scripts/encoding_timing_scripts"
./exp_tool_comparisons_2026_FM_run.sh $binary_tree_min $binary_tree_max $binary_tree_step
...
$python_behaverify ./src/dsl_to_latex.py ./metamodel/behaverify.tx ./examples/BT2BIP/MarsRover.tree ./examples/BT2BIP/LaTeX/MarsRover.tex
$python_behaverify ./src/dsl_to_latex.py ./metamodel/behaverify.tx ./examples/BT2BIP/TrainControl.tree ./examples/BT2BIP/LaTeX/TrainControl.tex
$python_behaverify ./src/dsl_to_latex.py ./metamodel/behaverify.tx ./examples/BT2Fiacre/drone3.tree ./examples/BT2Fiacre/LaTeX/drone3.tex
$python_behaverify ./src/dsl_to_latex.py ./metamodel/behaverify.tx ./examples/BT2Fiacre/droneNew.tree ./examples/BT2Fiacre/LaTeX/droneNew.tex
...
$python_behaverify ./src/dsl_to_latex.py ./metamodel/behaverify.tx ./examples/MoVe4BT/tree/binary_tree_2.tree ./examples/MoVe4BT/LaTeX/binary_tree_2.tex
...
$python_behaverify ./src/counter_trace.py ./metamodel/behaverify.tx ./examples/BT2Fiacre/drone3.tree ./examples/BT2Fiacre/results/INVAR_full_opt_drone3_2.txt ./examples/BT2Fiacre/processed_data

cd "${this_script_location}/examples/MoVe4BT"
