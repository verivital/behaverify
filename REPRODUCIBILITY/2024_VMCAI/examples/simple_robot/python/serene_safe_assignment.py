...
def x(new_value):
    ...
    if new_value >= 0 and new_value <= 7:
        ...
        raise SereneAssignmentException('variable x expected value between 0 and 7 inclusive but received value ' + str(new_value))
...
def y(new_value):
    ...
    if new_value >= 0 and new_value <= 7:
        ...
        raise SereneAssignmentException('variable y expected value between 0 and 7 inclusive but received value ' + str(new_value))
...
def target_x(new_value):
    ...
    if new_value >= 0 and new_value <= 7:
        ...
        raise SereneAssignmentException('variable target_x expected value between 0 and 7 inclusive but received value ' + str(new_value))
...
def target_y(new_value):
    ...
    if new_value >= 0 and new_value <= 7:
        ...
        raise SereneAssignmentException('variable target_y expected value between 0 and 7 inclusive but received value ' + str(new_value))
