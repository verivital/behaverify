...
import py_trees
import t8
import t8_environment

blackboard_reader = t8.create_blackboard()
environment = t8_environment.t8_environment(blackboard_reader)
root = t8.create_tree(environment)
...
def print_blackboard():
    ...
    ret_string += indent(1) + 'blFROZENVAR6: ' + str(blackboard_reader.blFROZENVAR6) + os.linesep
...
node_to_locals = {
    'a3' : [{'name' : 'localVAR2', 'is_func' : False, 'array_size' : None}, {'name' : 'localDEFINE7', 'is_func' : True, 'array_size' : 3}, {'name' : 'localDEFINE10', 'is_func' : True, 'array_size' : None}],
}
