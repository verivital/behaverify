...
def create_blackboard():
    ...
    blackboard_reader.blVAR0 = serene_safe_assignment.blVAR0(min(-2, max(-5, abs((-3 + -97)))))
    blackboard_reader.blVAR2 = serene_safe_assignment.blVAR2((not ((False ^ False))))


    def blDEFINE4():
        return min(-2, max(-5, ([(-100 < blackboard_reader.blVAR0), (blackboard_reader.blVAR2 == False), (blackboard_reader.blVAR0 > 15), (blackboard_reader.blVAR0 != blackboard_reader.blVAR0)].count(True))))
...
def create_tree(environment):
    ...
    a2_1 = a2_file.a2('a2_1', environment)
    a1 = a1_file.a1('a1', environment)
    p_all1 = py_trees.composites.Parallel(name = 'p_all1', policy = py_trees.common.ParallelPolicy.SuccessOnAll(True), children = [a2_1, a1])
    p_all1.tick = parallel_better_tick.__get__(p_all1, py_trees.composites.Parallel)
    p_all0 = py_trees.composites.Parallel(name = 'p_all0', policy = py_trees.common.ParallelPolicy.SuccessOnAll(False), children = [a2, p_all1])
