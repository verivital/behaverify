...
import py_trees
import t11
import t11_environment

blackboard_reader = t11.create_blackboard()
environment = t11_environment.t11_environment(blackboard_reader)
root = t11.create_tree(environment)
...
node_to_locals = {
    'a2' : [{'name' : 'localDEFINE3', 'is_func' : True, 'array_size' : 2}],
    'a2_1' : [{'name' : 'localDEFINE3', 'is_func' : True, 'array_size' : 2}],
    'a1' : [],
}
