...
import py_trees
import t13
import t13_environment

blackboard_reader = t13.create_blackboard()
environment = t13_environment.t13_environment(blackboard_reader)
root = t13.create_tree(environment)
...
node_to_locals = {
    'a3' : [{'name' : 'localDEFINE7', 'is_func' : True, 'array_size' : None}],
    'a4' : [{'name' : 'localDEFINE6', 'is_func' : True, 'array_size' : 3}],
}
