...
def create_blackboard():
    ...
    __temp_var__ = serene_safe_assignment.blVAR3([(0, (
        'yes'
        if (abs(-92) != blackboard_reader.blVAR0) else
        (
            'both'
            if ('both' != 'yes') else
            (
...
def create_tree(environment):
    ...
    p_all0 = py_trees.composites.Parallel(name = 'p_all0', policy = py_trees.common.ParallelPolicy.SuccessOnAll(False), children = [a3, c1, a4])
