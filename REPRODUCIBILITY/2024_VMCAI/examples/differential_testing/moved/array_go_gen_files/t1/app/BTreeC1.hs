...
bTreeFunctionC1 _ nodeLocation _ _ _ _ blackboard environment futureChanges
  | (sereneXNOR (sereneXNOR (sereneIMPLIES (boardBlDEFINE7 blackboard) (boardBlDEFINE7 blackboard)) True) (boardBlDEFINE7 blackboard)) = (Success, [], [], blackboard, environment, futureChanges)
