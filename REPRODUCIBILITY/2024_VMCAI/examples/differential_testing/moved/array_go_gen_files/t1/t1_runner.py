...
import py_trees
import t1
import t1_environment

blackboard_reader = t1.create_blackboard()
environment = t1_environment.t1_environment(blackboard_reader)
root = t1.create_tree(environment)
...
def print_environment():
    ...
    ret_string += indent(1) + 'envDEFINE4: ' + str(environment.envDEFINE4()) + os.linesep
    return ret_string
...
node_to_locals = {
    ...
    'a1' : [],
    'a4' : [{'name' : 'localVAR2', 'is_func' : False, 'array_size' : None}, {'name' : 'localDEFINE3', 'is_func' : True, 'array_size' : 2}],
}
