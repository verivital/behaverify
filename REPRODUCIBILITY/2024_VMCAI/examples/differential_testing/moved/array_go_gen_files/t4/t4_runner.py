...
import py_trees
import t4
import t4_environment

blackboard_reader = t4.create_blackboard()
environment = t4_environment.t4_environment(blackboard_reader)
root = t4.create_tree(environment)
...
node_to_locals = {
    'a3' : [{'name' : 'localVAR2', 'is_func' : False, 'array_size' : 2}, {'name' : 'localDEFINE4', 'is_func' : True, 'array_size' : 2}],
}
