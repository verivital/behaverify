...
class c1(py_trees.behaviour.Behaviour):
    ...
    def update(self):
        return_status = ((py_trees.common.Status.SUCCESS) if ((self.blackboard.blVAR0[0] >= (self.blackboard.blVAR0[0] * 77 * self.blackboard.blVAR0[0]))) else (py_trees.common.Status.FAILURE))
