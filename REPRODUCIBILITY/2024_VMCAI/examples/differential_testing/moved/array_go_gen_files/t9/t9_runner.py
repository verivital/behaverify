...
import py_trees
import t9
import t9_environment

blackboard_reader = t9.create_blackboard()
environment = t9_environment.t9_environment(blackboard_reader)
root = t9.create_tree(environment)
...
def print_environment():
    ...
    ret_string += indent(1) + 'envDEFINE7: ' + str([environment.envDEFINE7(x) for x in range(3)]) + os.linesep
    return ret_string


node_to_locals = {
    'a1' : [{'name' : 'localDEFINE5', 'is_func' : True, 'array_size' : 3}],
    'a4' : [],
}
