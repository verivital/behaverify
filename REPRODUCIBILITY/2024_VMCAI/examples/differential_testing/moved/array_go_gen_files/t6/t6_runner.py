...
import py_trees
import t6
import t6_environment

blackboard_reader = t6.create_blackboard()
environment = t6_environment.t6_environment(blackboard_reader)
root = t6.create_tree(environment)
...
def print_blackboard():
    ...
    ret_string += indent(1) + 'blVAR4: ' + str(blackboard_reader.blVAR4) + os.linesep
...
node_to_locals = {
    'a2' : [{'name' : 'localDEFINE7', 'is_func' : True, 'array_size' : None}],
    'a4' : [],
    'a1' : [],
}
