...
class c1(py_trees.behaviour.Behaviour):
    def __init__(self, name):
        ...
        self.blackboard.register_key(key = ('blVAR4'), access = py_trees.common.Access.READ)
    ...
    def update(self):
        return_status = ((py_trees.common.Status.SUCCESS) if ((min(self.blackboard.blDEFINE5(), -68) <= 9)) else (py_trees.common.Status.FAILURE))
