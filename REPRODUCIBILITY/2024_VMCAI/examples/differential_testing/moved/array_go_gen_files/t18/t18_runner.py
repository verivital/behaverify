...
import py_trees
import t18
import t18_environment

blackboard_reader = t18.create_blackboard()
environment = t18_environment.t18_environment(blackboard_reader)
root = t18.create_tree(environment)
...
def print_environment():
    ...
    ret_string += indent(1) + 'envDEFINE5: ' + str([environment.envDEFINE5(x) for x in range(2)]) + os.linesep
