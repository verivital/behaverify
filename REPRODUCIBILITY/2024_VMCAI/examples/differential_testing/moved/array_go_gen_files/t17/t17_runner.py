...
import py_trees
import t17
import t17_environment

blackboard_reader = t17.create_blackboard()
environment = t17_environment.t17_environment(blackboard_reader)
root = t17.create_tree(environment)
...
node_to_locals = {
    'a1' : [],
    'a4' : [{'name' : 'localVAR3', 'is_func' : False, 'array_size' : 2}],
    'a4_1' : [{'name' : 'localVAR3', 'is_func' : False, 'array_size' : 2}],
    'a1_1' : [],
}
