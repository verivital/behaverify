...
class a3(py_trees.behaviour.Behaviour):
    ...
    def update(self):
        ...
        self.environment.delay_this_action(self.environment.a3_write_after_1__0, self)
        self.environment.a3_write_after_1__1(self)
        self.blackboard.blVAR0 = serene_safe_assignment.blVAR0(min(5, max(2, self.blackboard.blVAR0)))
