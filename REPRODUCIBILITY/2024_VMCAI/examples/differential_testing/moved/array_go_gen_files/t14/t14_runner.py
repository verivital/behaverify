...
import py_trees
import t14
import t14_environment

blackboard_reader = t14.create_blackboard()
environment = t14_environment.t14_environment(blackboard_reader)
root = t14.create_tree(environment)
