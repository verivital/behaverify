...
import py_trees
import t10
import t10_environment

blackboard_reader = t10.create_blackboard()
environment = t10_environment.t10_environment(blackboard_reader)
root = t10.create_tree(environment)
...
node_to_locals = {
    'a3' : [{'name' : 'localVAR2', 'is_func' : False, 'array_size' : 3}, {'name' : 'localDEFINE4', 'is_func' : True, 'array_size' : None}, {'name' : 'localDEFINE6', 'is_func' : True, 'array_size' : 2}],
}
