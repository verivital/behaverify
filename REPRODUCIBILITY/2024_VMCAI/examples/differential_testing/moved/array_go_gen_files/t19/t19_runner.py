...
import py_trees
import t19
import t19_environment

blackboard_reader = t19.create_blackboard()
environment = t19_environment.t19_environment(blackboard_reader)
root = t19.create_tree(environment)
...
def print_blackboard():
    ...
    ret_string += indent(1) + 'blDEFINE6: ' + str([blackboard_reader.blDEFINE6(x) for x in range(2)]) + os.linesep
    return ret_string
...
node_to_locals = {
    'a1' : [{'name' : 'localDEFINE5', 'is_func' : True, 'array_size' : 2}],
    'a1_1' : [{'name' : 'localDEFINE5', 'is_func' : True, 'array_size' : 2}],
}
