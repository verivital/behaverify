...
import py_trees
import t12
import t12_environment

blackboard_reader = t12.create_blackboard()
environment = t12_environment.t12_environment(blackboard_reader)
root = t12.create_tree(environment)
...
def print_blackboard():
    ...
    ret_string += indent(1) + 'blDEFINE3: ' + str(blackboard_reader.blDEFINE3()) + os.linesep
