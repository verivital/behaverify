...
import py_trees
import t16
import t16_environment

blackboard_reader = t16.create_blackboard()
environment = t16_environment.t16_environment(blackboard_reader)
root = t16.create_tree(environment)
...
def print_blackboard():
    ...
    ret_string += indent(1) + 'blDEFINE7: ' + str([blackboard_reader.blDEFINE7(x) for x in range(3)]) + os.linesep
    return ret_string
...
def print_environment():
    ...
    ret_string += indent(1) + 'envFROZENVAR5: ' + str(environment.envFROZENVAR5) + os.linesep
    ret_string += indent(1) + 'envFROZENVAR6: ' + str(environment.envFROZENVAR6) + os.linesep
    return ret_string


node_to_locals = {
    'a2' : [{'name' : 'localVAR4', 'is_func' : False, 'array_size' : None}, {'name' : 'localDEFINE8', 'is_func' : True, 'array_size' : None}, {'name' : 'localDEFINE10', 'is_func' : True, 'array_size' : None}],
}
