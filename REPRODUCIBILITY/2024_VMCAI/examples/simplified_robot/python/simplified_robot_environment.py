...
class simplified_robot_environment():
    ...
    def __init__(self, blackboard):
        ...
        self.x_goal = serene_safe_assignment.x_goal(random.choice([0, 1, 2, 3, 4, 5, 6, 7]))
        self.y_goal = serene_safe_assignment.y_goal(random.choice([0, 1, 2, 3, 4, 5, 6, 7]))
        self.x_true = serene_safe_assignment.x_true(random.choice([0, 1, 2, 3, 4, 5, 6, 7]))
        self.y_true = serene_safe_assignment.y_true(random.choice([0, 1, 2, 3, 4, 5, 6, 7]))
    ...
    def go_x_func__0(self, node):
        self.x_true = serene_safe_assignment.x_true(max(0, min(7, (self.x_true + node.x_dir))))
        return

    def go_y_func__0(self, node):
        self.y_true = serene_safe_assignment.y_true(max(0, min(7, (self.y_true + node.y_dir))))
        return
