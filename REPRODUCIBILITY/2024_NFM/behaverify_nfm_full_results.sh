...
./exp_ANSR_no_net_create.sh
cd "${this_script_location}/scripts/encoding_timing_scripts"
./exp_ANSR_no_net_run.sh
cd "${this_script_location}/scripts/process_results_scripts"
./exp_ANSR_no_net_table.sh


cd "${this_script_location}/scripts/build_scripts"
./exp_bigger_fish_selector_create.sh 50 1000 50
cd "${this_script_location}/scripts/encoding_timing_scripts"
./exp_bigger_fish_selector_run.sh 50 1000 50
cd "${this_script_location}/scripts/process_results_scripts"
./exp_bigger_fish_selector_table.sh 50 1000 50
