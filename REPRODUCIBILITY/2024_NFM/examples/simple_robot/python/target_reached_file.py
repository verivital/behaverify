...
class target_reached(py_trees.behaviour.Behaviour):
    ...
    def update(self):
        return_status = ((py_trees.common.Status.SUCCESS) if (((self.blackboard.x == self.blackboard.target_x) and (self.blackboard.y == self.blackboard.target_y))) else (py_trees.common.Status.FAILURE))
