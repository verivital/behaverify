...
./exp_bigger_fish_selector_create.sh 50 100 50
cd "${this_script_location}/scripts/encoding_timing_scripts"
./exp_bigger_fish_selector_run.sh 50 100 50
cd "${this_script_location}/scripts/process_results_scripts"
./exp_bigger_fish_selector_table.sh 50 100 50


cd "${this_script_location}/scripts/build_scripts"
./exp_simple_robot_create.sh 2 6 4
cd "${this_script_location}/scripts/encoding_timing_scripts"
./exp_simple_robot_run.sh 2 6 4
cd "${this_script_location}/scripts/process_results_scripts"
./exp_simple_robot_table.sh 2 6 4
