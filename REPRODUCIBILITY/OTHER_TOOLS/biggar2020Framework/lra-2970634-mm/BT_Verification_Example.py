...
It is based on BT_Verification_Example.ipynb, but doesn't require jupiter.
In essence, it is a copy of each cell of the notebook to create something that can more conveniently run with docker.
We divide cells using comments and include any text that was in the original notebook in comments
'''



# cell 1
print('NOW ON: cell 01')
'''
