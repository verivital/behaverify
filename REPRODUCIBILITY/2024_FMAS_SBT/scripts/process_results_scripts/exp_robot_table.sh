...
for encoding_group in "${encoding_groups[@]}"; do
    ...
    $python_command ./build_table.py --folder_name robot --file_name robot --minV $min_val --maxV $max_val --step $step_size --xLabel "Grid Size" --encodings $encoding_group
done
