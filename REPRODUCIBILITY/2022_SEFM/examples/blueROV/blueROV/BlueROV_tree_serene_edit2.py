...
def create_root():
    ...
    hsd_pipe2bb = py_trees.behaviours.SetBlackboardVariable(
        name="hsd_pipe2bb",
        variable_value = 0, variable_name="/iver0/hsd_pipeline_mapping" 
    )
    hsd_surface2bb = py_trees.behaviours.SetBlackboardVariable(
        name="hsd_surface2bb",
        variable_value = 0, variable_name="/iver0/hsd_to_surface" 
    )
    hsd_rth2bb = py_trees.behaviours.SetBlackboardVariable(
        name="hsd_rth2bb",
        variable_value = 0, variable_name="/iver0/hsd_to_rth" 
    )
    hsd_wp2bb = py_trees.behaviours.SetBlackboardVariable(
        name="hsd_wp2bb",
        variable_value = 0, variable_name="/iver0/hsd_to_waypoint" 
    )
    fls2bb = py_trees.behaviours.SetBlackboardVariable(
        name="fls2bb",
        variable_value = 0, variable_name="/iver0/fls_echosunder" 
    )
    fls_warning2bb = py_trees.behaviours.SetBlackboardVariable(
        name="fls_warning2bb",
        variable_value = 0, variable_name="/iver0/obstacle_in_view"
    )
    battery2bb = py_trees.behaviours.SetBlackboardVariable(
        name="battery2bb",
        variable_value = 0, variable_name="/iver0/pixhawk_hw"
    )
    ddlecam2bb = py_trees.behaviours.SetBlackboardVariable(
        name="ddlecam2bb",
        variable_value = 0, variable_name="/lec_dd_am/p_value" 
    )
    rth2bb = py_trees.behaviours.SetBlackboardVariable(
        name="rth2bb",
        variable_value = 0, variable_name="/iver0/bb_rth"
    )
    geofence2bb = py_trees.behaviours.SetBlackboardVariable(
        name="geofence2bb",
        variable_value = 0, variable_name="/iver0/bb_geofence" 
    )
    lec2_am_l_2bb = py_trees.behaviours.SetBlackboardVariable(
        name="lec2_am_l_2bb",
        variable_value = 0, variable_name="/lec2_am/left/p_value"
    )
    lec2_am_r_2bb = py_trees.behaviours.SetBlackboardVariable(
        name="lec2_am_r_2bb",
        variable_value = 0, variable_name="/lec2_am/right/p_value"
    )
    pipe_lost2bb = py_trees.behaviours.SetBlackboardVariable(
        name="pipe_lost2bb",
        variable_value = 0, variable_name="/iver0/bb_pipe_lost" 
    )
    sensor_failure2bb = py_trees.behaviours.SetBlackboardVariable(
        name="sensor_failure2bb",
        variable_value = 0, variable_name="/iver0/sensor_failure_rpm" 
    )
    waypoints_completed2bb = py_trees.behaviours.SetBlackboardVariable(
        name="waypoints_completed2bb",
        variable_value = 0, variable_name="/iver0/waypoints_completed" 
    )
    home2bb = py_trees.behaviours.SetBlackboardVariable(
        name="home2bb",
        variable_value = 0, variable_name="/iver0/bb_home_dist"
    )
    home2bb1 = py_trees.behaviours.SetBlackboardVariable(
        name="home2bb1",
        variable_value = 0, variable_name="/iver0/bb_home_dist"
    )
    mission2bb = py_trees.behaviours.SetBlackboardVariable(
        name="mission2bb",
        variable_value = 0, variable_name="/iver0/bb_mission" 
    )
    ddlec2bb = py_trees.behaviours.SetBlackboardVariable(
        name="ddlec2bb",
        variable_value = 0, variable_name="/iver0/degradation_detector"
    )
    rtreach2bb = py_trees.behaviours.SetBlackboardVariable(
        name="rtreach2bb",
        variable_value = 0, variable_name="/reachability_result"
    )
