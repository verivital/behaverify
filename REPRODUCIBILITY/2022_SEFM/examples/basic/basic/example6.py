...
def create_root(print_pic=False):
    seq1 = py_trees.composites.Sequence('example_6_seq1')
    ...
    seq7 = py_trees.composites.Sequence('seq7')
    ...
    seq2.add_children([seq4, seq5])
    seq3.add_children([seq6, seq7])
    seq4.add_children([d9, d10])
    seq5.add_children([d11, d12])
    seq6.add_children([d13, d14])
    seq7.add_children([d15, d16])
    if print_pic:
