...
python3 ./build_table.py --folder_name checklist --file_name checklist_parallel checklist_sequence --minV $min_val --maxV $max_val --step $step_size --xLabel "Number of Checks" --encodings "all" "internal" "core" "aut" "func"
