...
python3 ./build_table.py --folder_name simple_robot --file_name simple_robot --minV $min_val --maxV $max_val --step $step_size --xLabel "Grid Size" --encodings "all" "internal" "core" "aut" "func" "opt"
