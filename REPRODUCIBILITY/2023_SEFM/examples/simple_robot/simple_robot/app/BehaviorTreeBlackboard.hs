...
updateBoardTargetX blackboard value
  | 0 > value || value > 1 = error "target_x illegal value"
...
updateBoardTargetY blackboard value
  | 0 > value || value > 1 = error "target_y illegal value"
