import py_trees
import p_all_f_s
import p_all_f_s_environment

blackboard_reader = p_all_f_s.create_blackboard()
environment = p_all_f_s_environment.p_all_f_s_environment(blackboard_reader)
root = p_all_f_s.create_tree(environment)
