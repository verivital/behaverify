import py_trees
import sel_s_r
import sel_s_r_environment

blackboard_reader = sel_s_r.create_blackboard()
environment = sel_s_r_environment.sel_s_r_environment(blackboard_reader)
root = sel_s_r.create_tree(environment)
