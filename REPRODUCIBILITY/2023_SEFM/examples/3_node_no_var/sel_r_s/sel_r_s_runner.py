import py_trees
import sel_r_s
import sel_r_s_environment

blackboard_reader = sel_r_s.create_blackboard()
environment = sel_r_s_environment.sel_r_s_environment(blackboard_reader)
root = sel_r_s.create_tree(environment)
