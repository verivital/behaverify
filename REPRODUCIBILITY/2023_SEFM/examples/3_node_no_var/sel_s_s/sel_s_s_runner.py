import py_trees
import sel_s_s
import sel_s_s_environment

blackboard_reader = sel_s_s.create_blackboard()
environment = sel_s_s_environment.sel_s_s_environment(blackboard_reader)
root = sel_s_s.create_tree(environment)
