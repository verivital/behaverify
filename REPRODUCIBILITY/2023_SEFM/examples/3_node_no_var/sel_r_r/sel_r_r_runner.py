import py_trees
import sel_r_r
import sel_r_r_environment

blackboard_reader = sel_r_r.create_blackboard()
environment = sel_r_r_environment.sel_r_r_environment(blackboard_reader)
root = sel_r_r.create_tree(environment)
