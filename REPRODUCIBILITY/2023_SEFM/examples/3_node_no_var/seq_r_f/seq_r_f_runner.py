import py_trees
import seq_r_f
import seq_r_f_environment

blackboard_reader = seq_r_f.create_blackboard()
environment = seq_r_f_environment.seq_r_f_environment(blackboard_reader)
root = seq_r_f.create_tree(environment)
