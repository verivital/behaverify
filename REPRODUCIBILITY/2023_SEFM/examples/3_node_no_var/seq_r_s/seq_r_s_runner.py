import py_trees
import seq_r_s
import seq_r_s_environment

blackboard_reader = seq_r_s.create_blackboard()
environment = seq_r_s_environment.seq_r_s_environment(blackboard_reader)
root = seq_r_s.create_tree(environment)
