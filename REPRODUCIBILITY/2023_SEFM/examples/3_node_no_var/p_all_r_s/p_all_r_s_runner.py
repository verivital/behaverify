import py_trees
import p_all_r_s
import p_all_r_s_environment

blackboard_reader = p_all_r_s.create_blackboard()
environment = p_all_r_s_environment.p_all_r_s_environment(blackboard_reader)
root = p_all_r_s.create_tree(environment)
