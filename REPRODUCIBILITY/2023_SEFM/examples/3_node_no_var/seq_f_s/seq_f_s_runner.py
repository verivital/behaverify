import py_trees
import seq_f_s
import seq_f_s_environment

blackboard_reader = seq_f_s.create_blackboard()
environment = seq_f_s_environment.seq_f_s_environment(blackboard_reader)
root = seq_f_s.create_tree(environment)
