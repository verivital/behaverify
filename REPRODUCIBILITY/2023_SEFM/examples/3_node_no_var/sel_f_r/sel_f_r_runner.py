import py_trees
import sel_f_r
import sel_f_r_environment

blackboard_reader = sel_f_r.create_blackboard()
environment = sel_f_r_environment.sel_f_r_environment(blackboard_reader)
root = sel_f_r.create_tree(environment)
