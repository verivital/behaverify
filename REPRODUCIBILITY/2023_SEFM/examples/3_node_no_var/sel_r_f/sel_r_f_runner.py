import py_trees
import sel_r_f
import sel_r_f_environment

blackboard_reader = sel_r_f.create_blackboard()
environment = sel_r_f_environment.sel_r_f_environment(blackboard_reader)
root = sel_r_f.create_tree(environment)
