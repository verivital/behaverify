import py_trees
import seq_r_r
import seq_r_r_environment

blackboard_reader = seq_r_r.create_blackboard()
environment = seq_r_r_environment.seq_r_r_environment(blackboard_reader)
root = seq_r_r.create_tree(environment)
