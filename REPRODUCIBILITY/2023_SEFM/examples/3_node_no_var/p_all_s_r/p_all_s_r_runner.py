import py_trees
import p_all_s_r
import p_all_s_r_environment

blackboard_reader = p_all_s_r.create_blackboard()
environment = p_all_s_r_environment.p_all_s_r_environment(blackboard_reader)
root = p_all_s_r.create_tree(environment)
