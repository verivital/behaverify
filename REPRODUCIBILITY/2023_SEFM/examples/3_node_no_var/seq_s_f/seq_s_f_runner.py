import py_trees
import seq_s_f
import seq_s_f_environment

blackboard_reader = seq_s_f.create_blackboard()
environment = seq_s_f_environment.seq_s_f_environment(blackboard_reader)
root = seq_s_f.create_tree(environment)
