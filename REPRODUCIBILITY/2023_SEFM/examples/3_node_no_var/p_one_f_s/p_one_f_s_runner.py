import py_trees
import p_one_f_s
import p_one_f_s_environment

blackboard_reader = p_one_f_s.create_blackboard()
environment = p_one_f_s_environment.p_one_f_s_environment(blackboard_reader)
root = p_one_f_s.create_tree(environment)
