import py_trees
import p_one_s_f
import p_one_s_f_environment

blackboard_reader = p_one_s_f.create_blackboard()
environment = p_one_s_f_environment.p_one_s_f_environment(blackboard_reader)
root = p_one_s_f.create_tree(environment)
