import py_trees
import sel_s_f
import sel_s_f_environment

blackboard_reader = sel_s_f.create_blackboard()
environment = sel_s_f_environment.sel_s_f_environment(blackboard_reader)
root = sel_s_f.create_tree(environment)
