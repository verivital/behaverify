import py_trees
import seq_s_s
import seq_s_s_environment

blackboard_reader = seq_s_s.create_blackboard()
environment = seq_s_s_environment.seq_s_s_environment(blackboard_reader)
root = seq_s_s.create_tree(environment)
