import py_trees
import seq_f_f
import seq_f_f_environment

blackboard_reader = seq_f_f.create_blackboard()
environment = seq_f_f_environment.seq_f_f_environment(blackboard_reader)
root = seq_f_f.create_tree(environment)
