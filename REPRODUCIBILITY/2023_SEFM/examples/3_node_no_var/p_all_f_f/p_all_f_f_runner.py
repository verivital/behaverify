import py_trees
import p_all_f_f
import p_all_f_f_environment

blackboard_reader = p_all_f_f.create_blackboard()
environment = p_all_f_f_environment.p_all_f_f_environment(blackboard_reader)
root = p_all_f_f.create_tree(environment)
