import py_trees
import p_one_f_r
import p_one_f_r_environment

blackboard_reader = p_one_f_r.create_blackboard()
environment = p_one_f_r_environment.p_one_f_r_environment(blackboard_reader)
root = p_one_f_r.create_tree(environment)
