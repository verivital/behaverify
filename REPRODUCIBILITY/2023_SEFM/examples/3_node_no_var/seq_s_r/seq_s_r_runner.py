import py_trees
import seq_s_r
import seq_s_r_environment

blackboard_reader = seq_s_r.create_blackboard()
environment = seq_s_r_environment.seq_s_r_environment(blackboard_reader)
root = seq_s_r.create_tree(environment)
