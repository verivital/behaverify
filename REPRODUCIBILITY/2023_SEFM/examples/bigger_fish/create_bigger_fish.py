...
def create_variables():
    return ('variables {variable { bl biggest_fish VAR [0, 199] assign { result {0} end_result} }}' + os.linesep)
...
def create_actions():
    return (
        ...
        + indent(3) + 'variable_statement { biggest_fish assign {result { (min, (addition, 1, biggest_fish), 199) } } } end_variable_statement' + os.linesep
