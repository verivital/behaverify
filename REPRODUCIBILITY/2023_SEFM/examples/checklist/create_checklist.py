...
def create_specifications(x):
    return (
        ...
        + ''.join(
            [
                (
                    indent(1) + 'LTLSPEC { (globally, (implies, (failure, success_failure_node' + (('_' + str(i)) if i > 0 else '') + '), (success, success_node' + (('_' + str(i)) if i > 0 else '') + '))) } end_LTLSPEC' + os.linesep
                    + indent(1) + 'LTLSPEC { (globally, (implies, (failure, success_failure_node' + (('_' + str(i)) if i > 0 else '') + '), (not, (success, success_node' + (('_' + str(i)) if i > 0 else '') + ')))) } end_LTLSPEC' + os.linesep
                    + indent(1) + 'CTLSPEC { (always_globally, (implies, (failure, success_failure_node' + (('_' + str(i)) if i > 0 else '') + '), (success, success_node' + (('_' + str(i)) if i > 0 else '') + '))) } end_CTLSPEC' + os.linesep
                    + indent(1) + 'CTLSPEC { (always_globally, (implies, (failure, success_failure_node' + (('_' + str(i)) if i > 0 else '') + '), (not, (success, success_node' + (('_' + str(i)) if i > 0 else '') + ')))) } end_CTLSPEC' + os.linesep
