...
def west_light(new_value):
    if not isinstance(new_value, bool):
        raise SereneAssignmentException('variable west_light expected type bool but received type ' + str(type(new_value)))
    return new_value


def east_light(new_value):
    if not isinstance(new_value, bool):
        raise SereneAssignmentException('variable east_light expected type bool but received type ' + str(type(new_value)))
    return new_value
