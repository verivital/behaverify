...
class move(py_trees.behaviour.Behaviour):
    ...
    def update(self):
        self.blackboard.cur_x = serene_safe_assignment.cur_x(max(0, min(10, (self.delta_x + self.blackboard.cur_x))))
        self.blackboard.cur_y = serene_safe_assignment.cur_y(max(0, min(10, (self.delta_y + self.blackboard.cur_y))))
