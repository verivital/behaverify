...
def create_root(print_pic=False):
    ...
    ACTION_close_doors = py_trees.behaviours.Running('ACTION_close_doors')
    ACTION_open_doors = py_trees.behaviours.Running('ACTION_open_doors')
    ACTION_move = py_trees.behaviours.Running('ACTION_move')
    ...
    SELECTOR_elevator = py_trees.composites.Selector('SELECTOR_elevator_2', memory = False)
