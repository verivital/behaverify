...
checkValueEnvTarX value
  | 0 > value || value > 6 = error "envTarX illegal value"
  | otherwise = value

checkValueEnvTarY :: Integer -> Integer
checkValueEnvTarY value
  | 0 > value || value > 6 = error "envTarY illegal value"
  | otherwise = value
  ...
  where
    ...
    tickUpdate1TarX environment
      ...
      where
        ...
        privateRandom1 1 = (min 6 ((envTarX environment) + 1))
    ...
    tickUpdate2TarY environment
      ...
      where
        ...
        privateRandom1 1 = (min 6 ((envTarY environment) + 1))
...
initialEnvironment seed blackboard = BTreeEnvironment newSereneGenerator newValTarX newValTarY newValTimer  where
    ...
    initValTarX curGen = (privateRandom0 (fst (getRandomInteger curGen 6)), snd (getRandomInteger curGen 6))
      where
    ...
    initValTarY curGen = (privateRandom0 (fst (getRandomInteger curGen 6)), snd (getRandomInteger curGen 6))
      where
