import sys
from generate_data import generate_table_simple
from misc_util import extract_info, handle_path

template = 'template_SIMPLE_fake_network.tree'
obstacle_path = sys.argv[1]
(min_val, max_val, fly_at, number_of_obstacles, max_size) = extract_info(obstacle_path)
generate_table_simple(min_val, max_val, obstacle_path, obstacle_path.replace('obstacles', 'table'))
