 ...
 *
 * nbits_obs: 13 (width: 1), nbits_all: 13 (width: 1)
...
/* INFO: input ordering:
   system_drone_x.3 (system.drone_x.3) : 0
   system_drone_x.2 (system.drone_x.2) : 1
   system_drone_x.1 (system.drone_x.1) : 2
   system_drone_x.0 (system.drone_x.0) : 3
   system_drone_y.3 (system.drone_y.3) : 4
   system_drone_y.2 (system.drone_y.2) : 5
   system_drone_y.1 (system.drone_y.1) : 6
   system_drone_y.0 (system.drone_y.0) : 7
   system_drone_speed.0 (system.drone_speed.0) : 8
   system_delta_x.1 (system.delta_x.1) : 9
   system_delta_x.0 (system.delta_x.0) : 10
   system_delta_y.1 (system.delta_y.1) : 11
   system_delta_y.0 (system.delta_y.0) : 12
*/
...
typedef struct {
  ...
  unsigned int system_delta_x : 1;
  unsigned int system_delta_y : 1;
} monitor_mask_t;
...
int user_interface(int drone_x, int drone_y, int drone_speed, int delta_x, int delta_y);
