...
for category in "${categories[@]}"; do
	...
	python3 ../../../src/dsl_to_nuxmv.py ../../../metamodel/behaverify.tx "${category}/${tail_end}/design_time/ANSRtFilled_${tail_end}.tree" "${category}/${tail_end}/design_time/smv/ANSRtFilled_${tail_end}.smv" --recursion_limit 10000 --no_checks
	sleep 3
    done
done
