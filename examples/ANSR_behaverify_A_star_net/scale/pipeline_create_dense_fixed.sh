...
for (( i==1; i<9; i++ )); do
    ...
    echo "${meta_dim}"
    python3 ../a_star_files/generate_obstacles.py "${meta_dim}"
    ...
    echo "moving .tree"
    mv "../a_star_files/ignore/ANSRtFilled_${tail_end}.tree" "./dense_fixed/${tail_end}/ANSRtFilled_${tail_end}.tree"
    mv "../a_star_files/ignore/obstaclesFilled_${tail_end}.txt" "./dense_fixed/${tail_end}/obstaclesFilled_${tail_end}.txt"
    meta_dim=$((meta_dim + 1))
done
