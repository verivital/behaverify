...
def print_blackboard():
    ...
    ret_string += indent(1) + 'x_true: ' + str(blackboard_reader.x_true) + os.linesep
    ret_string += indent(1) + 'y_true: ' + str(blackboard_reader.y_true) + os.linesep
    return ret_string
...
def print_environment():
    ...
    ret_string += indent(1) + 'goal_reached: ' + str(environment.goal_reached) + os.linesep
    return ret_string
