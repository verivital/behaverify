...
class move(py_trees.behaviour.Behaviour):
    ...
    def update(self):
        self.blackboard.x_true = serene_safe_assignment.x_true(max(0, min(20, (self.blackboard.x_true + self.x_dir))))
        self.blackboard.y_true = serene_safe_assignment.y_true(max(0, min(20, (self.blackboard.y_true + self.y_dir))))
