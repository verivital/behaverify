...
simple_robot_tree = simple_robot.create_tree()
...
while (count < 50 and break_count > 0):
    count = count + 1
    simple_robot_tree.tick_once()
    simple_robot_environment.execute_delayed_action_queue()
    simple_robot_environment.between_tick_environment_update()
    draw_board()
