...
betweenTickUpdate (blackboard, curEnvironment) = (blackboard, newEnvironment)
  where
    ...
    tickUpdateXGoal environment
      ...
      | (((envXGoal environment) == (envXTrue environment)) && ((envYGoal environment) == (envYTrue environment))) = environment { sereneEnvGenerator = (snd (getRandomInt (sereneEnvGenerator environment) 9)), envXGoal = privateRandom0 (fst (getRandomInt (sereneEnvGenerator environment) 9)) }
    ...
    tickUpdateYGoal environment
      ...
      | (((envXGoal environment) == (envXTrue environment)) && ((envYGoal environment) == (envYTrue environment))) = environment { sereneEnvGenerator = (snd (getRandomInt (sereneEnvGenerator environment) 9)), envYGoal = privateRandom0 (fst (getRandomInt (sereneEnvGenerator environment) 9)) }
...
initialEnvironment seed blackboard = BTreeEnvironment newSereneGenerator newValXGoal newValYGoal newValXTrue newValYTrue newValRemainingGoals
  where
    ...
    initValXGoal curGen = (privateRandom0 (fst (getRandomInt curGen 9)), snd (getRandomInt curGen 9))
      where
        privateRandom0 :: Int -> Int
        privateRandom0 0 = 0
        privateRandom0 1 = 1
    ...
    initValYGoal curGen = (privateRandom0 (fst (getRandomInt curGen 9)), snd (getRandomInt curGen 9))
      where
        privateRandom0 :: Int -> Int
        privateRandom0 0 = 0
        privateRandom0 1 = 1
    ...
    initValXTrue curGen = (privateRandom0 (fst (getRandomInt curGen 9)), snd (getRandomInt curGen 9))
      where
        privateRandom0 :: Int -> Int
        privateRandom0 0 = 0
        privateRandom0 1 = 1
    ...
    initValYTrue curGen = (privateRandom0 (fst (getRandomInt curGen 9)), snd (getRandomInt curGen 9))
      where
        privateRandom0 :: Int -> Int
        privateRandom0 0 = 0
        privateRandom0 1 = 1
    ...
    initValRemainingGoals curGen = (privateRandom0 (fst (getRandomInt curGen 2)), snd (getRandomInt curGen 2))
      where
        privateRandom0 :: Int -> Int
        privateRandom0 0 = 1
        privateRandom0 1 = 2
