...
class ANSR_environment():
    ...
    def create_geometry_message(self, point, function_convert_bt_to_waypoint, map_info):
        go_to = geometry_msgs.msg.PoseStamped()
        (go_to.pose.position.x, go_to.pose.position.y, go_to.pose.position.z) = function_convert_bt_to_waypoint(map_info, point, self.height_modifier)
    ...
    def send_path_segment_function(self, path_segment, function_convert_bt_to_waypoint, map_info):
        ...
        message_to_send.path = [self.create_geometry_message(point, function_convert_bt_to_waypoint, map_info) for point in path_segment]
