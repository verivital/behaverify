...
biases_0 = numpy_helper.from_array(numpy.array([0, 0, 0], dtype = numpy.float32), name = 'biases_0')
biases_1 = numpy_helper.from_array(numpy.array([0, 1, 0], dtype = numpy.float32), name = 'biases_1')
biases_2 = numpy_helper.from_array(numpy.array([0, 1, 0], dtype = numpy.float32), name = 'biases_2')
biases_3 = numpy_helper.from_array(numpy.array([0, 0], dtype = numpy.float32), name = 'biases_3')
biases_out = numpy_helper.from_array(numpy.array([0], dtype = numpy.float32), name = 'biases_out')

weights_0 = numpy_helper.from_array(numpy.array([[1, -1, 0], [-1, 1, 1]], dtype = numpy.float32), name = 'weights_0')
weights_1 = numpy_helper.from_array(numpy.array([[1, -1, 0], [1, -1, 0], [0, 0, 1]], dtype = numpy.float32), name = 'weights_1')
weights_2 = numpy_helper.from_array(numpy.array([[1, 0, 0], [0, 0, -1], [0, -1, 1]], dtype = numpy.float32), name = 'weights_2')
weights_3 = numpy_helper.from_array(numpy.array([[-1, 0], [1, 0], [0, 1]], dtype = numpy.float32), name = 'weights_3')
