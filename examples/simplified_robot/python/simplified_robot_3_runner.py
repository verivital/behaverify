import os
import py_trees
import simplified_robot_3
import simplified_robot_3_environment

blackboard_reader = simplified_robot_3.create_blackboard()
environment = simplified_robot_3_environment.simplified_robot_3_environment(blackboard_reader)
root = simplified_robot_3.create_tree(environment)
