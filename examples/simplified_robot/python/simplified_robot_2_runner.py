import os
import py_trees
import simplified_robot_2
import simplified_robot_2_environment

blackboard_reader = simplified_robot_2.create_blackboard()
environment = simplified_robot_2_environment.simplified_robot_2_environment(blackboard_reader)
root = simplified_robot_2.create_tree(environment)
