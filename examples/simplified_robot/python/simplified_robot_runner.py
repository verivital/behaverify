import os
import py_trees
import simplified_robot
import simplified_robot_environment

blackboard_reader = simplified_robot.create_blackboard()
environment = simplified_robot_environment.simplified_robot_environment(blackboard_reader)
root = simplified_robot.create_tree(environment)
