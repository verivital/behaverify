...
def x_goal(new_value):
    ...
    if new_value >= 0 and new_value <= 1:
        ...
        raise SereneAssignmentException('variable x_goal expected value between 0 and 1 inclusive but received value ' + str(new_value))
...
def y_goal(new_value):
    ...
    if new_value >= 0 and new_value <= 1:
        ...
        raise SereneAssignmentException('variable y_goal expected value between 0 and 1 inclusive but received value ' + str(new_value))
...
def x_true(new_value):
    ...
    if new_value >= 0 and new_value <= 1:
        ...
        raise SereneAssignmentException('variable x_true expected value between 0 and 1 inclusive but received value ' + str(new_value))
...
def y_true(new_value):
    ...
    if new_value >= 0 and new_value <= 1:
        ...
        raise SereneAssignmentException('variable y_true expected value between 0 and 1 inclusive but received value ' + str(new_value))
