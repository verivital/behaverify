...
class simplified_robot_3_environment():
    ...
    def __init__(self, blackboard):
        ...
        self.x_goal = serene_safe_assignment.x_goal(random.choice([0, 1, 2]))
        self.y_goal = serene_safe_assignment.y_goal(random.choice([0, 1, 2]))
        self.x_true = serene_safe_assignment.x_true(random.choice([0, 1, 2]))
        self.y_true = serene_safe_assignment.y_true(random.choice([0, 1, 2]))
    ...
    def go_x_func__0(self, node):
        self.x_true = serene_safe_assignment.x_true(max(0, min(2, (self.x_true + node.x_dir))))
        return

    def go_y_func__0(self, node):
        self.y_true = serene_safe_assignment.y_true(max(0, min(2, (self.y_true + node.y_dir))))
        return
