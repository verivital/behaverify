...
import py_trees
import t99
import t99_environment

blackboard_reader = t99.create_blackboard()
environment = t99_environment.t99_environment(blackboard_reader)
root = t99.create_tree(environment)
...
def print_environment():
    ...
    ret_string += indent(1) + 'envDEFINE4: ' + str([environment.envDEFINE4(x) for x in range(2)]) + os.linesep
    return ret_string
