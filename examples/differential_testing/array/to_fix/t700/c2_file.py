...
class c2(py_trees.behaviour.Behaviour):
    ...
    def update(self):
        return_status = ((py_trees.common.Status.SUCCESS) if (((38 != self.blackboard.blVAR0[serene_safe_assignment.index_func(max(0, min(2, 4)), 3)]) == (True == False))) else (py_trees.common.Status.FAILURE))
