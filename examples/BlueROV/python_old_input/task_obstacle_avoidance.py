...
class TaskHandler(py_trees.behaviour.Behaviour):
    ...
    def __init__(self, 
                 name ,  
                 enable_obstacle_avoidance=None,#<textx:btree.DefaultBBType instance at 0x7fcb5b5f0f10>
                ):                 
        ...
        #self.blackboard.bb_obstacle_warning = <textx:btree.DefaultBBType instance at 0x7fcb5b5f0d90>
