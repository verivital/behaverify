...
"""
This node captures if the waypoints are completed
"""
...
class ToBlackboard(py_trees.behaviours.SetBlackboardVariable):
    ...
    Blackboard Variables:
        * bb_waypoints_completed: the raw message from topic /iver0/waypoints_completed
    Args:
    ...
    def __init__(self, 
                    name, 
                    topic_name="bb_waypoints_completed"        
                ):

        super(ToBlackboard, self).__init__(name=name,
                                           #topic_name=topic_name,
                                           #topic_type=Bool,
                                           #blackboard_variables={"bb_waypoints_completed":None},
                                           variable_name="bb_waypoints_completed",
                                           variable_value=None
        ...
        #self.blackboard.bb_waypoints_completed = Bool()
        

"""
############<<USER INIT CODE BEGINS>>##############################
        self.blackboard.bb_waypoints_completed.data = False
############<<USER INIT CODE ENDS>>################################
"""
    #def update(self):
"""
