...
class TaskHandler(py_trees.behaviour.Behaviour):
    ...
    def __init__(self, 
                 name ,  
                 uuv_min_speed=None,#<textx:btree.DefaultBBType instance at 0x7fcb5b5f2e20>
                ):                 
        ...
        #self.uuv_min_speed=uuv_min_speed     
"""
...
############<<USER UPDATE CODE BEGINS>>##############################
        self.blackboard.HSD_out.speed = self.uuv_min_speed
