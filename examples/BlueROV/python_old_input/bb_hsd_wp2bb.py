...
"""
This node captures HSD input from waypoint node
"""
...
class ToBlackboard(py_trees.behaviours.SetBlackboardVariable):
    ...
    Blackboard Variables:
        * hsd_to_waypoint: the raw message from topic /iver0/hsd_to_waypoint
    Args:
    ...
    def __init__(self, 
        ...
        super(ToBlackboard, self).__init__(name=name,
                                           ...
                                           #blackboard_variables={"hsd_to_waypoint":None},
                                           variable_name="hsd_to_waypoint",
                                           variable_value=None
        ...
        #self.blackboard.hsd_to_waypoint = HSDCommand()
