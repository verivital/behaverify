...
class TaskHandler(py_trees.behaviour.Behaviour):
    ...
    def __init__(self, 
                 name ,  
                 num_classes=None,#<textx:btree.DefaultBBType instance at 0x7fcb5b5f7be0>, 
                 ann_input_len=None,#<textx:btree.DefaultBBType instance at 0x7fcb5b5f7d30>, 
                 ddlec_am_path=None,#<textx:btree.DefaultBBType instance at 0x7fcb5b5f7e80>, 
                 ddlec_am_params=None,#<textx:btree.DefaultBBType instance at 0x7fcb5b5f7fd0>
                ):                 
