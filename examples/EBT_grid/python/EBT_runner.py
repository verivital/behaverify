...
def print_blackboard(blackboard_reader):
    ...
    ret_string += indent(1) + 'obstacles_sort_x: ' + str([blackboard_reader.obstacles_sort_x(x) for x in range(40)]) + os.linesep
    ret_string += indent(1) + 'obstacles_sort_y: ' + str([blackboard_reader.obstacles_sort_y(x) for x in range(40)]) + os.linesep
    ret_string += indent(1) + 'waypoint_x: ' + str(blackboard_reader.waypoint_x) + os.linesep
    ret_string += indent(1) + 'waypoint_y: ' + str(blackboard_reader.waypoint_y) + os.linesep
    ret_string += indent(1) + 'landmark: ' + str([blackboard_reader.landmark(x) for x in range(50)]) + os.linesep
    ret_string += indent(1) + 'current_landmark_x: ' + str(blackboard_reader.current_landmark_x()) + os.linesep
    ret_string += indent(1) + 'current_landmark_y: ' + str(blackboard_reader.current_landmark_y()) + os.linesep
    return ret_string
