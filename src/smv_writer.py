    ...
    for node_id in range(0, len(nodes)):
        ...
        if node['category'] == 'leaf':
            ...
            if 'without_memory' in node['type']:
                var_string += "\t\t" + node['name'] + " : " + node['category'] + '_' + node['type'] + "_" + str(len(node['children'])) + "(" + children_string
                ...
                var_string += "\t\t" + node['name'] + " : " + node['category'] + '_' + node['type'] + "_" + str(len(node['children'])) + "(" + children_string + resume_point
                ...
                if 'unsynchronized' in node['type']:
                    ...
                    if children_string == "":
                        ...
                        children_string = children_string + ', '
                    var_string += "\t\t" + node['name'] + " : " + node['category'] + '_' + node['type'] + "_" + str(len(node['children'])) + "(" + children_string + " parallel_skip_" + str(node_id)
            else:
