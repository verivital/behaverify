...
with open('./size_models/stats', 'r') as cur_file:
...
plt.plot(vals_size)
plt.savefig('./size_models/sizes.png')
print(vals_size)
plt.close()
plt.plot(vals_diameter)
plt.savefig('./size_models/system_diameter.png')
print(vals_diameter)
plt.close()
"""
...
plt.savefig('./size_models/reachable_total_states_pow.png')
