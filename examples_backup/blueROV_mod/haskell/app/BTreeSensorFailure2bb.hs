module BTreeSensorFailure2bb where
...
bTreeFunctionSensorFailure2bb :: [BTreeNode] -> TreeLocation -> TrueMemoryStatus -> [TrueMemoryStorage] -> PartialMemoryStatus -> [PartialMemoryStorage] -> BTreeBlackboard -> BTreeEnvironment -> FutureChanges -> BTreeNodeOutput
bTreeFunctionSensorFailure2bb _ nodeLocation _ _ _ _ oldBlackboard oldEnvironment futureChanges = (returnStatus, [], [], newBlackboard, newEnvironment, newFutureChanges)
  where
    ...
    boardEnvUpdate0 boardEnv
      ...
      where
        ...
        privateTempBoardEnv2 = (updateBoardBbSensorFailureWarning blackboard ((boardBbSensorFailureWarning blackboard) || (envBbSensorFailure environment)), environment)
          where
