...
def create_blackboard():
    ...
    blackboard_reader.register_key(key = 'x_net_output', access = py_trees.common.Access.WRITE)
    ...
    blackboard_reader.register_key(key = 'y_net_output', access = py_trees.common.Access.WRITE)
    ...
    blackboard_reader.x_net_output = x_net_output
    ...
    blackboard_reader.y_net_output = y_net_output
