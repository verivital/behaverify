...
def print_blackboard():
    ...
    ret_string += indent(1) + 'x_net_output: ' + str(blackboard_reader.x_net_output()) + os.linesep
    ...
    ret_string += indent(1) + 'y_net_output: ' + str(blackboard_reader.y_net_output()) + os.linesep
    return ret_string
